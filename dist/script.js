...
/* harmony import */ var _modules_puctureSize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/puctureSize */ "./src/js/modules/puctureSize.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_2__["default"])(".feedback-slider-item", "hor", ".main-prev-btn", ".main-next-btn");
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_2__["default"])(".main-slider-item", "ver");
...
var burger = function burger(burgerSelector, menuSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    ...
    if (menuElem.style.display === 'none' && window.screen.availWidth <= 992) {
      ...
      setTimeout(function () {
        return menuElem.style.display = 'none';
      }, 400);
    }
  });
...
var drop = function drop() {
  ...
  // 	item.closest('.file_upload').style.border = "5px solid #255326";
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots = arrName[0].length > 7 ? "..." : ".";
      var name = arrName[0].substring(0, 8) + dots + arrName[1];
...
var filter = function filter() {
  ...
  var typeFitler = function typeFitler(markType) {
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight) - 1;
